...
old_line = '<div class="absolute w-full" style="height: 4px; top: 68px; left: 0; z-index: 0; background-color: #ffffff;"></div>'
new_line = '<div class="absolute w-full" style="height: 4px; top: 5.5rem; left: 0; z-index: 0; background-color: #ffffff;"></div>'
